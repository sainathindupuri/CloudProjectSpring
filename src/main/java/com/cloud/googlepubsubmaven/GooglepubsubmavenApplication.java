...
public class GooglepubsubmavenApplication {

	public static void main(String[] args) {
		SpringApplication.run(GooglepubsubmavenApplication.class, args);
	}
...
//		PubSubInboundChannelAdapter adapter = new PubSubInboundChannelAdapter(pubSubTemplate, "CloudProject-sub");
...
//	}
	...
	public MessageHandler messageSender(PubSubOperations pubsubTemplate) {
		return new PubSubMessageHandler(pubsubTemplate, "CloudProject");
	}
